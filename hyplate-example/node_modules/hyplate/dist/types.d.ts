...
export type EventMap<T extends EventTarget> = T extends HTMLElement ? HTMLElementEventMap : T extends SVGElement ? SVGElementEventMap : T extends XMLHttpRequestEventTarget ? XMLHttpRequestEventMap : never;
export type Handler<T extends EventTarget, E extends Extract<keyof EventMap<T>, string>> = (this: T, e: EventMap<T>[E]) => void;
export type Events<T extends EventTarget> = Extract<keyof EventMap<T>, string>;
export type EventHost<T extends EventTarget> = <E extends Events<T>>(name: E, handler: Handler<T, E>, options?: boolean | EventListenerOptions) => CleanUpFunc;
 ...
 * Slot name map for
 */
export type SlotMap<S extends string = string> = [S] extends [never] ? undefined : Partial<Record<S, Element | DocumentFragment | Mountable<any>>>;
export type ExposeBase = {} | void;
export type PropsBase = {};
export type Mountable<E extends ExposeBase> = (attach: AttachFunc) => Rendered<E>;
export type WithChildren<C> = {
    children: C;
};
export type WithRef<E extends HTMLElement> = {
    ref: Later<E>;
};
export type Props<P extends PropsBase, C = undefined, E = undefined> = Omit<P, "children" | "ref"> & (C extends undefined ? Partial<WithChildren<C>> : WithChildren<C>) & (E extends HTMLElement ? Partial<WithRef<E>> : {});
export type FunctionalComponent<P extends PropsBase = PropsBase, C = undefined, E extends ExposeBase = void> = (props: Props<P, C>) => Mountable<E>;
export type FunctionalComponentTemplateFactory = <S extends string = never>(input: string | HTMLTemplateElement, name?: string) => <P extends PropsBase, E extends ExposeBase>(setup?: (props: P) => E) => FunctionalComponent<P, undefined | SlotMap<S>, E>;
/**
...
} & ElementAttributes<E> & JSX.IntrinsicAttributes;
type _EventName<E extends string> = E extends `on${infer e}` ? e : never;
type FunctionalGlobalEventHandler = {
    [K in keyof GlobalEventHandlers as `on${Capitalize<_EventName<K>>}`]: (event: Parameters<Extract<GlobalEventHandlers[K], (...args: any[]) => any>>[0]) => void;
};
...
type ReferrerPolicyOptions = EnumeratedValues<"no-referrer" | "no-referrer-when-downgrade" | "origin" | "origin-when-cross-origin" | "same-origin" | "strict-origin" | "strict-origin-when-cross-origin" | "unsafe-url">;
...
type AutoCompleteHints = "off" | "on" | "name" | "honorific-prefix" | "given-name" | "additional-name" | "family-name" | "honorific-suffix" | "nickname" | "email" | "username" | "new-password" | "current-password" | "one-time-code" | "organization-title" | "organization" | "street-address" | `address-line${1 | 2 | 3}` | `address-level${1 | 2 | 3 | 4}` | "country" | "country-name" | "postal-code" | "cc-name" | "cc-given-name" | "cc-additional-name" | "cc-family-name" | "cc-number" | "cc-exp" | "cc-exp-month" | "cc-exp-year" | "cc-csc" | "cc-type" | "transaction-currency" | "transaction-amount" | "language" | "bday" | "bday-day" | "bday-month" | "bday-year" | "sex" | "tel" | "tel-country-code" | "tel-national" | "tel-area-code" | "tel-local" | "tel-local-prefix" | "tel-extension" | "impp" | "url" | "photo";
/**
...
interface MapAttributeToValueAndKeys {
    ...
    readonly: AttributeInfo<BooleanAttributeValue, Except<"hidden" | "range" | "color" | "checkbox" | "radio" | "button">>;
...
type ExtractType<K extends InputTypes, A extends keyof MapAttributeToValueAndKeys> = MapAttributeToValueAndKeys[A] extends AttributeInfo<unknown, infer V> ? (K extends V ? A : never) : never;
type InputAttributes = {
    [K in InputTypes]: {
        type: K;
    } & {
        [A in keyof MapAttributeToValueAndKeys as ExtractType<K, A>]: MapAttributeToValueAndKeys[A] extends AttributeInfo<infer T, any> ? T : never;
    };
}[InputTypes];
 ...
 */
interface GlobalAttributes extends GeneralAttributes<"accesskey" | "class" | `data-${string}` | "enterkeyhint" | "id" | "is" | "itemid" | "itemprop" | "itemref" | "itemscope" | "itemtype" | "lang" | "nonce" | "onabort" | "onautocomplete" | "onautocompleteerror" | "onblur" | "oncancel" | "oncanplay" | "oncanplaythrough" | "onchange" | "onclick" | "onclose" | "oncontextmenu" | "oncuechange" | "ondblclick" | "ondrag" | "ondragend" | "ondragenter" | "ondragleave" | "ondragover" | "ondragstart" | "ondrop" | "ondurationchange" | "onemptied" | "onended" | "onerror" | "onfocus" | "oninput" | "oninvalid" | "onkeydown" | "onkeypress" | "onkeyup" | "onload" | "onloadeddata" | "onloadedmetadata" | "onloadstart" | "onmousedown" | "onmouseenter" | "onmouseleave" | "onmousemove" | "onmouseout" | "onmouseover" | "onmouseup" | "onmousewheel" | "onpause" | "onplay" | "onplaying" | "onprogress" | "onratechange" | "onreset" | "onresize" | "onscroll" | "onseeked" | "onseeking" | "onselect" | "onshow" | "onsort" | "onstalled" | "onsubmit" | "onsuspend" | "ontimeupdate" | "ontoggle" | "onvolumechange" | "onwaiting" | "part" | "title">, BooleanAttributes<"autofocus" | "contenteditable" | "draggable" | "inert" | "spellcheck">, FunctionalGlobalEventHandler {
    /** @deprecated */
    "xml:lang": string;
    /** @deprecated */
    "xml:base": string;
    ...
    role: EnumeratedValues<"alert" | "alertdialog" | "application" | "article" | "banner" | "button" | "cell" | "checkbox" | "columnheader" | "combobox" | "complementary" | "contentinfo" | "definition" | "dialog" | "directory" | "document" | "feed" | "figure" | "form" | "grid" | "gridcell" | "group" | "heading" | "img" | "link" | "list" | "listbox" | "listitem" | "log" | "main" | "marquee" | "math" | "menu" | "menubar" | "menuitem" | "menuitemcheckbox" | "menuitemradio" | "meter" | "navigation" | "none" | "note" | "option" | "presentation" | "progressbar" | "radio" | "radiogroup" | "region" | "row" | "rowgroup" | "rowheader" | "scrollbar" | "search" | "searchbox" | "separator" | "slider" | "spinbutton" | "status" | "switch" | "tab" | "table" | "tablist" | "tabpanel" | "term" | "textbox" | "timer" | "toolbar" | "tooltip" | "tree" | "treegrid" | "treeitem">;
    /**
...
declare global {
    namespace JSX {
        ...
        interface IntrinsicElements {
            ...
            area: Attributes<GlobalAttributes & {
                alt: string;
                coords: string;
                download: string;
                href: string;
            ...
            audio: Attributes<GlobalAttributes & PlayerAttributes & {
                /**
                 * @experimental
                 */
            ...
            button: Attributes<GlobalAttributes & FormElementAttributes & {
            ...
            col: Attributes<GlobalAttributes & {
                span: NumericAttributeValue;
            }, HTMLTableColElement>;
            colgroup: Attributes<GlobalAttributes & {
                span: NumericAttributeValue;
            }, HTMLTableColElement>;
            data: Attributes<GlobalAttributes & {
                value: string;
            }, HTMLDataElement>;
            ...
            details: Attributes<GlobalAttributes & {
                open: BooleanAttributeValue;
            }, HTMLDetailsElement>;
            dfn: Attributes<GlobalAttributes, HTMLElement>;
            dialog: Attributes<Omit<GlobalAttributes, "tabindex"> & {
                open: BooleanAttributeValue;
            }, HTMLDialogElement>;
            ...
            embed: Attributes<GlobalAttributes & SizeOptions & {
                src: string;
                type: string;
            }, HTMLEmbedElement>;
            fieldset: Attributes<GlobalAttributes & {
                disabled: BooleanAttributeValue;
                form: string;
                name: string;
            }, HTMLFieldSetElement>;
            ...
            form: Attributes<GlobalAttributes & {
            ...
            iframe: Attributes<GlobalAttributes & ExperimentalImportance & SizeOptions & {
                allow: string;
                /**
                 * @deprecated
                ...
                name: string;
                referrerpolicy: ReferrerPolicyOptions;
                sandbox: EnumeratedValues<"allow-downloads-without-user-activation" | "allow-forms" | "allow-modals" | "allow-orientation-lock" | "allow-pointer-lock" | "allow-popups" | "allow-popups-to-escape-sandbox" | "allow-presentation" | "allow-same-origin" | "allow-scripts" | "allow-storage-access-by-user-activation" | "allow-top-navigation" | "allow-top-navigation-by-user-activation">;
                src: string;
                srcdoc: string;
            }, HTMLIFrameElement>;
            img: Attributes<GlobalAttributes & ExperimentalImportance & SizeOptions & {
                alt: string;
                crossorigin: CORSOptions;
            ...
            label: Attributes<GlobalAttributes & {
                for: string;
            }, HTMLLabelElement>;
            legend: Attributes<GlobalAttributes, HTMLElement>;
            li: Attributes<GlobalAttributes & {
            ...
            link: Attributes<GlobalAttributes & ExperimentalImportance & {
                as: EnumeratedValues<"audio" | "document" | "embed" | "fetch" | "font" | "image" | "object" | "script" | "style" | "track" | "video" | "worker">;
                crossorigin: CORSOptions;
                href: string;
                hreflang: string;
                imagesizes: string;
            ...
            object: Attributes<GlobalAttributes & SizeOptions & {
                data: string;
                form: string;
                type: string;
                usemap: string;
            }, HTMLObjectElement>;
            ol: Attributes<GlobalAttributes & {
                reversed: BooleanAttributeValue;
                start: NumericAttributeValue;
                type: ListStyleType;
            }, HTMLOListElement>;
            optgroup: Attributes<GlobalAttributes & {
                disabled: BooleanAttributeValue;
                label: string;
            }, HTMLOptGroupElement>;
            option: Attributes<GlobalAttributes & {
                disabled: BooleanAttributeValue;
                label: string;
                selected: BooleanAttributeValue;
                value: string;
            }, HTMLOptionElement>;
            output: Attributes<GlobalAttributes & {
                for: string;
                form: string;
                name: string;
            }, HTMLOutputElement>;
            ...
            progress: Attributes<GlobalAttributes & {
                max: NumericAttributeValue;
                value: NumericAttributeValue;
            }, HTMLProgressElement>;
            q: Attributes<GlobalAttributes & {
                cite: string;
            }, HTMLQuoteElement>;
            ...
            script: Attributes<GlobalAttributes & ExperimentalImportance & {
            ...
            select: Attributes<GlobalAttributes & {
            ...
            slot: Attributes<GlobalAttributes & {
                name: string;
            }, HTMLSlotElement>;
            small: Attributes<GlobalAttributes, HTMLElement>;
            source: Attributes<GlobalAttributes & SizeOptions & {
                type: string;
                src: string;
                srcset: string;
                sizes: string;
            ...
            style: Attributes<GlobalAttributes & {
                media: string;
                nonce: string;
                title: string;
                blocking: string;
            ...
            th: Attributes<GlobalAttributes & {
                abbr: string;
                colspan: NumericAttributeValue;
                headers: string;
                rowspan: NumericAttributeValue;
            ...
            time: Attributes<GlobalAttributes & {
                datetime: string;
            }, HTMLTimeElement>;
            tr: Attributes<GlobalAttributes, HTMLTableRowElement>;
            track: Attributes<GlobalAttributes & {
            ...
            video: Attributes<GlobalAttributes & SizeOptions & PlayerAttributes & {
                /**
                 * @experimental
                 */
